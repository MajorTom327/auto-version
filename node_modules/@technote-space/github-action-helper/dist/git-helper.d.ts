...
export default class GitHelper {
    ...
    private initialize;
    useOrigin: (origin: string | boolean, quiet?: boolean) => void;
    ...
    fetchOrigin: (workDir: string, context: Context, options?: string[], refspec?: string[]) => Promise<void>;
    ...
    getRefDiff: (workDir: string, baseRef: string, compareRef: string, diffFilter?: string, dot?: '..' | '...') => Promise<string[]>;
