...
export declare const isValidSemanticVersioning: (version: string, strict?: boolean) => boolean;
...
export declare const split: (value: string, separator?: string | RegExp, limit?: number) => string[];
...
export declare const generateNewVersion: (lastTag: string, position?: number) => string;
...
export declare const objectGet: <T>(value: Record<string, any> | undefined | null, key: string, defaultValue?: T | undefined) => T | undefined;
